...
private:
	...
	unordered_map<uint64_t, Player*> m_mapPlayer;				// 전체 Player 관리
	unordered_set<Player*> m_Sector[dfSECTOR_Y_MAX][dfSECTOR_X_MAX];	// 각 섹터에 존재하는 Player 관리
	unordered_map<int64_t, uint64_t> m_accountNo;				// Player 계정 번호 관리
